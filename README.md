...
In this project, I will be using a cyber security tool called [Chronicle](https://cloud.google.com/chronicle/docs/overview), a cloud-native tool, to investigate a security incident that involved a phishing attack. The goal of this project is to showcase my knowledge of using this tool and how effective it is for me to identify threats.
